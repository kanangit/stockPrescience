...
export_csv = articles_df.to_csv (r'D:\kananovich\personal\OneDrive\Documents\family\jobsAnton\dataIncubator\stage02\myproject\data\scrapped\dumpBusinessDay20180928-20181008.csv', index = None, header=True) 