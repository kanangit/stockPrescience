...
userRPath = r"d:\kananovich\personal\OneDrive\Documents\family\jobsAnton\dataIncubator\stage02\myproject\data\scrapped\final\dumpFinancialSoupNoCroco20180101-20181101.csv"
userWPath = r"d:\kananovich\personal\OneDrive\Documents\family\jobsAnton\dataIncubator\stage02\myproject\data\scrapped\final\dumpFinancialSoupNoCroco20180101-20181101NoCroco.csv"
...
rList = readRecordList(userRPath)
for r in rList:
	r = remCroco(r)

with open(userWPath,'w',encoding='utf-8', newline='') as my_csv:
    data_writer = csv.writer(my_csv)
    for radok in rList:
    	if len(radok) != 0:    		
    		data_writer.writerow(radok)    

print('Dun. The masterfile is saved in ', userWPath)